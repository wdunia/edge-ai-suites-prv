...
The main Autonomous Mobile Robot platform is based on the 12th generation Intel® Core™ processor with accelerators primarily used for AI inference and vision processing. The platform inherits many security elements from the processor.
