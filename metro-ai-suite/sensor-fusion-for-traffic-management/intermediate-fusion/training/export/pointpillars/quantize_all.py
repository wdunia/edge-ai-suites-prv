...
Usage:
    /home/jie/env/bevEnv/bin/python export/pointpillars/quantize_all.py \\
...
def main():
    ...
    # PFE: use v7000 to match deploy's INT8 max_voxels=7000
    # (deploy/src/pipeline/split_pipeline_config.cpp:default_int8_pfe_model).
    # Fall back to the dynamic-V ONNX only if v7000 is missing.
